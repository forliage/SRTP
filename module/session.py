...
from module import interactor, round
...
class SessionFactory:
    ...
    def create_session(self, ids: list, instructions: list, applications: list, all_required_resources: list, mode: str = "normal", plan: str = "") -> BaseSession:
        """
        Create a session.
        :param ids: The id list of current task.
        :param instructions: The instruction list of current task.
        ...
        if mode == "normal":
            ...
            for idx in range(len(ids)):
                sessions.append(Session(ids[idx], instructions[idx], applications[idx], all_required_resources[idx]))
            return sessions
        elif mode == "follower":
...
class Session(BaseSession):
    ...
    def __init__(self, id: str, instruction: str, application: str, required_resources: str):
        """
        Initialize a session.
        :param id: The id of current task.
        """
