...
"""
This module contains the basic classes of Round and Session for the system.

A round of a session in manages a single user request and consists of multiple steps. 

A session may consists of multiple rounds of interactions.

The session is the core class. It manages the state transition and handles the different states, using the state pattern.
...
class BaseSession(ABC):
    """
    A basic session. A session consists of multiple rounds of interactions.
    The handle function is the core function to handle the session. Agent runs with the state transition and handles the different states, using the state pattern.
    ...
    def __init__(self, task: str) -> None:
        ...
        # Logging-related properties
        log_root = configs["LOG_ROOT"]
        self.log_path = f"{log_root}/{self.task}/"
